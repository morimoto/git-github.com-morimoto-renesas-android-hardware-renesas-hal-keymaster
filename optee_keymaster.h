...
public:
    ...
    OpteeKeymasterDevice(const hw_module_t* module);
...
private:
    ...
    // Static methods interfacing the HAL API with the OpteeKeymaster device
     ...
     */
    static keymaster_error_t add_rng_entropy(const struct keymaster2_device* dev, const uint8_t* data,
                                    size_t data_length);
     ...
     */
    static keymaster_error_t generate_key(const struct keymaster2_device* dev,
                                            const keymaster_key_param_set_t* params,
                                            keymaster_key_blob_t* key_blob,
                                            keymaster_key_characteristics_t* characteristics);
     ...
     */
    static keymaster_error_t get_key_characteristics(const struct keymaster2_device* dev,
                                                const keymaster_key_blob_t* key_blob,
                                                const keymaster_blob_t* client_id,
                                                const keymaster_blob_t* app_data,
                                                keymaster_key_characteristics_t* characteristics);
     ...
     */
    static keymaster_error_t import_key(const struct keymaster2_device* dev,
                                    const keymaster_key_param_set_t* params,
                                    keymaster_key_format_t key_format,
                                    const keymaster_blob_t* key_data,
                                    keymaster_key_blob_t* key_blob,
     ...
     */
    static keymaster_error_t attest_key(const struct keymaster2_device* dev,
     ...
     */
    static keymaster_error_t upgrade_key(const struct keymaster2_device* dev,
     ...
     */
    static keymaster_error_t delete_key(const struct keymaster2_device* dev,
                                    const keymaster_key_blob_t* key);
     ...
     * \param[in] dev The keymaster device structure.
     */
    static keymaster_error_t delete_all_keys(const struct keymaster2_device* dev);
     ...
     * KM_ERROR_OUTPUT_PARAMETER_NULL.
     */
    static keymaster_error_t begin(const struct keymaster2_device* dev, keymaster_purpose_t purpose,
                                const keymaster_key_blob_t* key,
                                const keymaster_key_param_set_t* in_params,
                                keymaster_key_param_set_t* out_params,
                                keymaster_operation_handle_t* operation_handle);
     ...
     * it).
     */
    static keymaster_error_t update(const struct keymaster2_device* dev,
                                keymaster_operation_handle_t operation_handle,
                                const keymaster_key_param_set_t* in_params,
    ...
    static int serialize(uint8_t* ptr, const size_t count,
                        const uint8_t* source, const uint32_t str_size);
    static int serializeParams(uint8_t* ptr,
                        const keymaster_key_param_set_t* params);
    static int serializePresence(uint8_t* ptr, const presence p);

    static int deserialize_key_blob(const uint8_t* out,
                        keymaster_key_blob_t* const key_blob,
                        keymaster_error_t* const res);
    static int deserialize_characteristics(const uint8_t* out,
                        keymaster_key_characteristics_t* const characteristics,
                        keymaster_error_t* const res);
    static int deserialize_blob(const uint8_t* out,
                        keymaster_blob_t* const export_data,
                        keymaster_error_t* const res);
    static int deserialize_param_set(const uint8_t* out,
                        keymaster_key_param_set_t* const params,
                        keymaster_error_t* const res);

    static int get_blob_size_in_params(const keymaster_key_param_set_t* params);

    static int check_and_push_params(uint8_t* ptr,
                        const keymaster_key_param_set_t* params);

    static int check_and_push_blob(uint8_t* ptr, const keymaster_blob_t* blob);

    keymaster2_device device_;
